...
public class GroupExtensionProvider implements RealmResourceProvider {
    ...
    public GroupExtensionProvider(RealmModel realm, GroupModel group, AdminPermissionEvaluator auth,
     ...
     *                            to return id, username, created, first and last
     *                            name, email, enabled
     *                            state, email verification state, federation link,
     *                            and access. Note that
     *                            it means that namely user attributes, required
