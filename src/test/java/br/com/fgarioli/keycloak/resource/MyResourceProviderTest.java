...
import br.com.fgarioli.keycloak.ExtensionProviderFactory;
...
public class MyResourceProviderTest {
    ...
    private RequestSpecification givenSpec() {
        return given().baseUri(keycloak.getAuthServerUrl()).basePath("/realms/master/" + ExtensionProviderFactory.ID);
    }
